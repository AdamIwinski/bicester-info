  ...
  mysqli_report(MYSQLI_REPORT_STRICT);
    ...
    try{
      ...
      if($connection -> connect_errno!=0)
        ...
        {
          $paid = $connection->query("SELECT * FROM cars ORDER BY id DESC");
          $cars = $paid-> fetch_all();
...
foreach ($cars as $car){
        ...
        echo 
          '<div class="jobcard">
          <a href="car.php?id='.$car[0].'">
            <div class="tile card m-3">
              <div class="card-body">
                <h3 class="card-title">'.htmlspecialchars($car[1]).'<br> <br></h3>
                ...
                <h4 class="mb-2">'.htmlspecialchars($car[2]).'</h4>
                <h4 class="mb-2">'.htmlspecialchars($car[3]).'</h4>
                <h4 class="mb-2">'.htmlspecialchars($car[5]).'</h4>
                <h4 class="mb-2">'.htmlspecialchars($car[6]).'</h4>
                <h4 class="mb-2">'.htmlspecialchars($car[7]).'</h4>
                <h4 class="mb-2">'.htmlspecialchars($car[8]).'</h4>
                <h4 class="mb-2">'.htmlspecialchars($car[9]).'</h4>
                <h4 class="mb-2">'.htmlspecialchars($car[10]).'</h4>
                <h4 class="mb-2">'.htmlspecialchars($car[11]).'</h4>
                <h4 class="mb-2">'.htmlspecialchars($car[12]).'</h4>
                <h4 class="mb-2">'.htmlspecialchars($car[13]).'</h4>
                <h4 class="mb-2">'.htmlspecialchars($car[14]).'</h4>
                <h4 class="mb-2">'.htmlspecialchars($car[15]).'</h4>
                <p class="location text-muted"> Location: '.htmlspecialchars($car[4]).'</p>
